      ...
      {open && (
        <div className="mb-3 w-72 bg-white rounded-xl shadow-lg border border-border overflow-hidden animate-in fade-in slide-in-from-bottom-2">
          <div className="p-4 border-b border-border bg-gradient-to-r from-emerald-50 to-white">
            ...
            <p className="text-xs text-text-muted mt-0.5">We&apos;re here to help you get the most out of FlowNex</p>
          </div>
          <div className="p-2">
            <a href={`https://wa.me/${SUPPORT_PHONE}?text=${encodeURIComponent("Hi, I need help with FlowNex.")}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-emerald-50 transition-colors">
            ...
            <a href={`mailto:${SUPPORT_EMAIL}?subject=FlowNex Support Request`} className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-purple-50 transition-colors">
