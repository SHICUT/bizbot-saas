...
const plans = [
  ...
  },
  {
    ...
    features: ["1K AI Replies/month", "AI Auto Reply", "Knowledge Base", "Conversations Inbox", "Leads CRM"],
    cta: "Choose Starter",
    highlight: false,
  },
  {
    ...
    features: ["5K AI Replies/month", "Everything in Starter", "Broadcast Campaigns", "Appointments", "Revenue Dashboard"],
    cta: "Choose Growth",
    highlight: true,
  },
  {
    ...
    features: ["20K AI Replies/month", "Everything in Growth", "AI Sales Employee", "Multi-Agent Access", "Advanced Analytics"],
    cta: "Choose Business",
    highlight: false,
  },
];
